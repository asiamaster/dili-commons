<script id="radioItem" type="text/html">
    <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="r{{value}}" value="{{value}}" name="{{name}}" class="custom-control-input" {{checked ?
        'checked':''}} {{required ? 'required':''}}>
        <label class="custom-control-label" for="r{{value}}">{{text}}</label>
    </div>
</script>
<script id="checkboxItem" type="text/html">
    <div class="custom-control custom-checkbox custom-control-inline">
        <input type="checkbox" id="c{{value}}" value="{{value}}" name="{{name}}" class="custom-control-input" {{checked
               ? 'checked':''}} {{required ? 'required':''}}>
        <label class="custom-control-label" for="c{{value}}">{{text}}</label>
    </div>
</script>

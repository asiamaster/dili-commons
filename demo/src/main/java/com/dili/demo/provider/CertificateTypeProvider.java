...
import com.dili.demo.glossary.CertificateTypeEnum;
 ...
 */
@Component
public class CertificateTypeProvider implements ValueProvider {

    private static final List<ValuePair<?>> BUFFER = new ArrayList<>();

    static {
        BUFFER.addAll(Stream.of(CertificateTypeEnum.values())
